...
export default function MultiplayerPlay({isCreator,name,GameId,setTimeSpent,Correct, incorrect,setinCorrectCount,setCorrectCount,time,gridSize,operator,columnNumbers,rowNumbers}) {
