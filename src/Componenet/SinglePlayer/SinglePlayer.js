...
console.log("gridsize:"+gridSize);
        ...
        return (
            ...
            <Route  path="/SinglePlayer/play" component={()=> < SinglePlayerPlay time={time}  gridSize ={gridSize.current} operator = {operator.current} time={time.current} numberRangeStart={ numberRangeStart.current } numberRangeEnd={numberRangeEnd.current} />} />
